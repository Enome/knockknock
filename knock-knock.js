...
(function () {
    ...
    var exports = module.exports;
    var __dirname = "/";
    var __filename = "//home/fs/work/jscode/knock-knock/src";
  ...
  Validation = (function() {
    function Validation() {}
    Validation.prototype.addRules = function() {
      ...
      return observable.subscribe(__bind(function() {
        return this.subscription.apply(this, [observable].concat(__slice.call(validators)));
      }, this));
    };
    Validation.prototype.subscription = function() {
